...
function carInformer(manufacturer, model, arbitraryKeyword, nameValuePairs, color, feature) {
    const car = {
        manufacturer,
        model,
        arbitraryKeyword,
...
carInformer("toyota", 2022, "Excellent performer", { Ower: "Harish" }, "Black", "Hybrid");